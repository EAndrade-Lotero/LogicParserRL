...
from utils.interpreters import parser_interpreter
from RLClasses.parser_utils import FormulaTransformer
from RLClasses.parser_atoms import Nodo, Estado, Embeddings
...
class ParserFOL(Parser):

    def __init__(self, frase, pregunta, respuesta, tipo_pregunta):
        super().__init__(frase, pregunta, respuesta, tipo_pregunta)
